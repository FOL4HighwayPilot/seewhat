...
class TaskFilter(filters.FilterSet):
    ...
    #is_deleted=filters.BooleanFilter(field_name="is_deleted", widget= "forms.CheckboxInput")
...
@method_decorator(name='update', decorator=swagger_auto_schema(operation_summary='Method restores a specific task, all attached jobs, annotations, and data'))
class TrashBinViewSet(auth.TaskGetQuerySetMixin, viewsets.ModelViewSet):
    ...
    def perform_update(self,serializer):
        ...
        db_task.save(update_fields=['is_deleted'])
